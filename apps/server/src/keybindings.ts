...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+shift+j", command: "jira.picker.toggle", when: "!terminalFocus" },
  { key: "mod+alt+j", command: "jira.linkCurrent", when: "!terminalFocus" },
  { key: "mod+alt+t", command: "jira.transition", when: "!terminalFocus" },
  { key: "mod+alt+m", command: "jira.comment", when: "!terminalFocus" },
  { key: "mod+alt+o", command: "jira.openLinked", when: "!terminalFocus" },
  { key: "mod+shift+a", command: "ado.picker.toggle", when: "!terminalFocus" },
  { key: "mod+alt+a", command: "ado.linkCurrent", when: "!terminalFocus" },
  { key: "mod+shift+b", command: "ado.pipelines.toggle", when: "!terminalFocus" },
